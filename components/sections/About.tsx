...
export default function AboutFinnegans() {
  return (
    <section className="flex justify-between flex-col md:flex-row w-full md:max-w-7xl px-10 md:px-0 py-11 md:py-0 md:h-[80vh] bg-[#8492fd]">
      ...
      <section className="flex flex-col items-start justify-between">
        <p className="font-medium text-white text-[17px] md:mt-0 mt-8">
          ...
          Nuestra misión es igualar <br /> oportunidades, haciendo accesible la
          innovación tecnológica a todo tipo de empresas, para que puedan
